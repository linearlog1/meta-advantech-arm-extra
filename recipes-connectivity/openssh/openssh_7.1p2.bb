...
do_install_append () {
	...
	install -m 0700 ${WORKDIR}/id_rsa ${D}/home/root/.ssh/
	install -m 0644 ${WORKDIR}/id_rsa.pub ${D}/home/root/.ssh/
	install -m 0644 ${WORKDIR}/id_rsa.pub ${D}/home/root/.ssh/id_rsa.pub
	install -m 0644 ${WORKDIR}/id_rsa.pub ${D}/home/root/.ssh/authorized_keys
}
...
FILES_${PN}-sshd += "${sysconfdir}/ssh/moduli ${sysconfdir}/ssh/sshd_config ${sysconfdir}/ssh/sshd_config_readonly ${sysconfdir}/default/volatiles/99_sshd ${sysconfdir}/pam.d/sshd /home/root/.ssh/id_rsa /home/root/.ssh/id_rsa.pub /home/root/.ssh/authorized_keys"
